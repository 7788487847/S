...
import ArtworkCatalogManager from "./ArtworkCatalogManager";

type Item = Record<string, unknown> & { id: number };
const tabs: Tab[] = [["artworks","作品审核"],["catalog","作品管理"],["applications","认证审核"],["profiles","资料审核"],["reports","举报处理"],["complaints","侵权投诉"],["contacts","联系留言"],["logs","操作日志"],["site","站点与公告"]];
